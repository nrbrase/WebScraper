...
public class Job3 implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_DS_Job3 = new byte[0];
		static byte[] commonByteArray_DS_Job3 = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_DS_Job3) {
	...
	public void tFixedFlowInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String fileName_tFileOutputExcel_1 = "/Users/kimdobert/Desktop/Talend-DS/DS/out.xls";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job3.class.getClassLoader()
					.getResourceAsStream(
							"ds/job3_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 29427 characters generated by Talend Open Studio for Data Integration on the
 * October 7, 2017 2:04:05 PM EDT
 ************************************************************************************************/
