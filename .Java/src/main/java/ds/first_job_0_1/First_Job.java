				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						{ // start of Var scope
							...
							// # Output table : 'out1'
							out1_tmp.new_data = JsoupScraper
						...
						if (out1 != null) {
							...
							if (out1.new_data != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(out1.new_data));
...
/************************************************************************************************
 * 36081 characters generated by Talend Open Studio for Data Integration on the
 * October 4, 2017 12:23:08 AM EDT
 ************************************************************************************************/
