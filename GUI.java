...
public class GUI extends readAllLinks implements ActionListener, ItemListener{
    ...
    public void actionPerformed(ActionEvent e)
    {
		...
		JLabel label = new JLabel("Gathering addresses, store numbers and phone numbers from "+ STATE+", please wait.");
		...
		// Makes it so mutiple things run at once for GUI
    ...
    public void files(JFrame loading)
    {
